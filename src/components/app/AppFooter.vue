<template>
  ...
  <v-footer height="40" class="bg-blue-grey-darken-4">
    <a
      v-for="item in items"
      :key="item.title"
      :href="item.href"
    ...
    >
      <div class="text-grey-darken-1"> &copy; {{ (new Date()).getFullYear() }} <span class="d-none d-sm-inline-block">Weaponized Audio, LLC</span>
    </div></div>
  </v-footer>
</template>
